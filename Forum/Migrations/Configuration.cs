    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Forum.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Forum.Models.ApplicationDbContext context)
        {
            if (!context.Users.Any())
            {
                ...
                {
                    Body =
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus in ultricies mauris, id posuere metus. Sed quis arcu quam. Sed cursus gravida nisi, vitae venenatis odio molestie ac.",
                    Email = "mishka@abv.bg",
                    ForumThread = thread1
                };
